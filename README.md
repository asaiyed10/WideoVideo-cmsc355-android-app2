...
-Share button is working fine but our emulator doesnt have the other apps (Facebook, Dropbox, etc) that allows us to share things. If it was on real phone it would work.
